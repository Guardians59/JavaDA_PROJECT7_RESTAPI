...
public class BidList {
    ...
    public BidList(int bidListId, @NotBlank(message = "Account is mandatory") String account,
	    @NotBlank(message = "Type is mandatory") String type,
	    @Positive(message = "Must be positive") Double bidQuantity, Double askQuantity, Double bid, Double ask,
